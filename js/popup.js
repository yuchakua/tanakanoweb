...
function popup1() {
    CreativaPopup.create('連絡先 developerhelpers ', 'Discord');
}
...
function popup13() {
    CreativaPopup.create('連絡先 <font class="contactding" onclick="allahm109kd(); allahm109kd2();" color="#FF0000">developerhelpers</font> &#10084<br> <font style="color: #696969; font-size: smaller;"> my discord server <a href="https://discord.gg/artk" style="color: #ADD8E6;">https://discord.gg/artk</a> </font>', 'Discord', '', {
        titleColor: '#6ffcff',
        textColor: '#b0b0b0'
    });
...
function allahm109kd() {
    navigator.clipboard.writeText("developerhelpers");
    setTimeout(function() {
        alert("ディスコードのIDをコピーしました");
    }, 50);
}
